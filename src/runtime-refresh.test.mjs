...
function createMinimalAgentState(remotePlannerOverrides = {}) {
  return {
    ...
    remote_asr_settings: { profile_name: null, provider: null, base_url: null, model: null, api_key_reference: null, api_key_masked_value: null, api_key_reference_error: null, organization_reference: null, project: null, language: null, temperature_milli: null, timeout_ms: null, endpoint_is_loopback: null, availability_reason: null, privacy_network_mode: "ask_per_origin", privacy_origin_rule_count: 0, privacy_notice: "Remote microphone privacy notice" },
    ...
    remote_tts_settings: { profile_name: null, provider: null, base_url: null, model: null, api_key_reference: null, api_key_masked_value: null, api_key_reference_error: null, organization_reference: null, project: null, voice: null, audio_format: null, timeout_ms: null, endpoint_is_loopback: null, availability_reason: null, privacy_network_mode: "ask_per_origin", privacy_origin_rule_count: 0, privacy_notice: "Remote narration privacy notice" },
