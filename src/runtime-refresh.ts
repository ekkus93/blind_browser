...
export function applyAgentStateToPanels(
  ...
  dependencies.setRemotePlannerPanelState({
    ...
    apiKeyReferenceError: agentState.remote_planner_settings.api_key_reference_error,
  ...
  dependencies.setRemoteAsrPanelState({
    ...
    apiKeyReferenceError: agentState.remote_asr_settings.api_key_reference_error,
  ...
  dependencies.setRemoteTtsPanelState({
    ...
    apiKeyReferenceError: agentState.remote_tts_settings.api_key_reference_error,
