...
pub(in crate::config) fn validate_safety_settings(safety: &SafetySettings, issues: &mut Vec<String>) {
...
pub(in crate::config) fn validate_model_settings(models: &ModelManagementSettings, issues: &mut Vec<String>) {
